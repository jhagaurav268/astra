({
    ...
    handleOnClick : function(component,event,helper){
      ...
      // event.preventDefault();
       var myEvent = component.getEvent("onClickLookup");
        myEvent.setParams({"isClickOnLookup": true});
        myEvent.fire();
    ...
    handleHideSearchList : function(component,event,helper){   
        $A.enqueueAction(component.get("c.hideSearchList"));
    },
    ...
    onSelectItem : function(component, event, helper) {
        ...
        for (var i = 0; i < results.length; i++) {
            if (results[i].Id == selectedId) {
                ...
                component.set("v.selectedName", results[i][returnFields[0]]);
                break;
            }
        }     
